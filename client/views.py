...
class ServiceTickets(View):
    def post(self,request):
        ...
        get_ticketID = request.POST.get('ticketID')
        ...
        ticket_status = AccountStatus.objects.get(account_status_id = '2') 
    ...
    def get(self,request):
        ...
        user_info = User.objects.get(id = current_user_id)
        service_status = ServiceDetails.objects.get(client_user = current_user_id)
        ticket_info = Tickets.objects.filter(client_user = current_user_id)
        ...
        return render(request,'client/service-tickets.html',context)
...
class TicketDetails(View):
    def get(self,request,id):
        ...
        user_info = User.objects.get(id = current_user_id)
        ticket_info = Tickets.objects.get(problem_ticket_id = id)
        ticket_response = TicketResponse.objects.filter(ticket_id = id)
        ...
        return render(request, 'client/ticket-details.html',context)
